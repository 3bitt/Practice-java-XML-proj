...
@Entity(name = "CbCompanyData")
@Table(name = "CBCOMPANYDATA")
@Inheritance(strategy = InheritanceType.JOINED)
public class CbCompanyData
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        if (!(object instanceof CbCompanyData)) {
            return false;
        }
        if (this == object) {
            return true;
        }
        final CbCompanyData that = ((CbCompanyData) object);
        {
            String lhsNip;
            lhsNip = this.getNip();
            String rhsNip;
